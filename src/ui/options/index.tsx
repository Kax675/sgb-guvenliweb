    ...
    <div className="max-w-2xl mx-auto py-12 px-6 font-sans text-neutral-900">
      <header className="flex items-center gap-4 mb-10">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight">
            Güvenli Web Ayarları
          </h1>
          <p className="text-sm text-neutral-500">
            İnternet deneyiminizi daha güvenli hale getirin.
          </p>
        </div>
      </header>
      ...
      <div className="min-h-[400px]">
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <section className="bg-white border border-neutral-200 rounded-xl p-6 shadow-sm">
              <Input
                ...
                onChange={(e) =>
                  save("protectionEnabled", (e.target as HTMLInputElement).checked)
                }
                className="mb-8"
              />
              ...
              <div className="pt-6 border-t border-neutral-100">
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <h3 className="font-semibold text-base">Bloklama Hassasiyeti</h3>
                    <p className="text-xs text-neutral-500">
                      Hangi kritiklik seviyesindeki bağlantıların engelleneceğini belirleyin.
                    </p>
                  </div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    save("minCriticality", parseInt((e.target as HTMLInputElement).value))
                  }
                />
                <div className="flex justify-between text-[10px] text-neutral-400 font-bold mt-2 uppercase tracking-tight">
        ...
        {activeTab === "whitelist" && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <section className="bg-white border border-neutral-200 rounded-xl p-6 shadow-sm">
              <h3 className="font-semibold text-base mb-1">Güvenli Alan Adları</h3>
              ...
              <div className="space-y-2">
                {settings.excludedDomains.length === 0 ? (
                  ...
                  settings.excludedDomains.map((domain) => (
                    ...
                    >
                      <span className="font-medium text-sm text-neutral-700">{domain}</span>
                      <button
        ...
        {activeTab === "performance" && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <section className="bg-white border border-neutral-200 rounded-xl p-6 shadow-sm">
              <h3 className="font-semibold text-base mb-1">Önbellek Ayarları</h3>
              <p className="text-sm text-neutral-500 mb-6">
                Tarama performansını artırmak için sorgu sonuçlarını geçici olarak saklayın.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <Input
                  ...
                  onChange={(e) =>
                    save("cacheDuration", Math.max(1, parseInt((e.target as HTMLInputElement).value) || 1))
                  }
                />
                <Input
                  type="number"
                  ...
                  onChange={(e) =>
                    save("cacheSize", Math.max(100, parseInt((e.target as HTMLInputElement).value) || 100))
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-sky-50 rounded-lg border border-sky-100">
                <div>
                  <span className="block text-[10px] font-bold text-sky-600 uppercase mb-0.5">
                    Mevcut Durum
                  </span>
      ...
      <footer className="mt-12 flex items-center justify-between pt-8 border-t border-neutral-100">
        <Button
          variant="secondary"
          onClick={handleReset}
          className="text-neutral-400 hover:text-neutral-700 border-none shadow-none"
        >

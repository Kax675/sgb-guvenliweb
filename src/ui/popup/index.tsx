...
function Popup() {
  ...
  return (
    <div className="w-[320px] p-4 font-sans bg-white text-neutral-900">
      ...
      >
        <div className={`w-2 h-2 rounded-full ${settings.protectionEnabled ? "bg-green-500" : "bg-red-500 animate-pulse"}`} />
        {settings.protectionEnabled ? "Aktif Koruma Etkin" : "Koruma Devre Dışı"}
      </div>

      <footer className="text-[11px] text-neutral-400 text-center mt-6 pt-4 border-t border-neutral-50">
        USOM Veri Tabanı ile Güçlendirilmiştir
      </footer>
    </div>
  );
}
